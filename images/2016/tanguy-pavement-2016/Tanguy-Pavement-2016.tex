...
\begin{marginfigure}
\centering
\frame{\includegraphics[width=\linewidth]{"2016/tanguy-pavement-2016/migface narrow".jpg}}
\label{migface}
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
    ...
    \begin{subfigure}[t]{0.59\textwidth}
        \centering
        \frame{\includegraphics[width=\linewidth]{"2016/tanguy-pavement-2016/WillScott-bolting".jpg}} 
        \caption{} \label{Will Scott bolting}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.393\textwidth}
        \centering
        \frame{\includegraphics[width=\linewidth]{"2016/tanguy-pavement-2016/Janet Pavement".jpg}} 
        \caption{} \label{Ice}
    \end{subfigure}
    ...
    \centering
        \frame{\includegraphics[width=\linewidth]{"2016/tanguy-pavement-2016/View of Razor".jpg}} 
...
\begin{marginfigure}
\centering
\frame{\includegraphics[width=\linewidth]{"2016/tanguy-pavement-2016/Bivi-chocolate".jpg}}
\label{chocolate}
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
    ...
    \begin{subfigure}[t]{0.393\textwidth} %16:9
        \centering
        \frame{\includegraphics[width=\linewidth]{2016/tanguy-pavement-2016/Ice-2016.jpg}} 
        \caption{} \label{Ice stalactite}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.59\textwidth} %square
        \centering
        \frame{\includegraphics[width=\linewidth]{"2016/tanguy-pavement-2016/Will TR01".jpg}} 
    ...
    \centering
        \frame{\includegraphics[width=\linewidth]{"2016/tanguy-pavement-2016/Ice curtain".jpg}} 
...
\begin{figure*}[t!]
\centering
\frame{\includegraphics[width=\linewidth]{"2016/tanguy-pavement-2016/icecave"}}
\contcaption{A hand drawn survey of TR01 with plan and elevation --- Tanguy Racine}
\label{scan}
\end{figure*}
\name{Tanguy Racine}
