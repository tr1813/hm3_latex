\section{Back to the Hollow Mountain}
     \begin{marginfigure}
        \centering
        \frame{\includegraphics[width=\linewidth]{"2016/back-to-the-hollow-mountain-2016/Krn in cloud".jpg}}
        \caption{The east face of Krn, with a small alp and limestone spur containing \emph{Poloska Jama}} \label{Krn}
    \end{marginfigure}
    \begin{marginfigure}
        \centering
        \frame{\includegraphics[width=\linewidth]{"2016/back-to-the-hollow-mountain-2016/Tolminka gorge".jpg}}
...
\checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
   \centering
    ...
    \centering
        \frame{\includegraphics[width=\linewidth]{"2016/back-to-the-hollow-mountain-2016/Migovec panorama".jpg}}
        \caption{} \label{Panorama from mule path}
    \end{subfigure}
    \begin{subfigure}[t]{0.453\textwidth}
        \centering
        \frame{\includegraphics[width=\linewidth]{"2016/back-to-the-hollow-mountain-2016/Migovec-selfie".jpg}}
        \caption{} \label{selfie}
    \end{subfigure}
    \begin{subfigure}[t]{0.537\textwidth}
        \centering
        \frame{\includegraphics[width=\linewidth]{"2016/back-to-the-hollow-mountain-2016/Kal-cooling".jpg}}
        \caption{} \label{Kal}
    \end{subfigure}
  \hfill
    \centering
    \begin{subfigure}[t]{\textwidth}
        \centering
        \frame{\includegraphics[width=\linewidth]{"2016/back-to-the-hollow-mountain-2016/Limestone cliffs".jpg}}
