...
\centering
    \begin{subfigure}[t]{0.565\textwidth}
        \centering
        \frame{\includegraphics[width=\linewidth]{"2015/other-finds-2015/CeciliaKan_Alex_Snowplug (1)".jpg}} 
        \caption{} \label{At the bottom of the lead}
    \end{subfigure}
        \hfill
\begin{subfigure}[t]{0.424\textwidth}
\centering
\frame{\includegraphics[width=\linewidth]{"2015/other-finds-2015/CeciliaKan_Snowplug (1)".jpg}}
 \caption{}\label{bottom of snowplug}
\end{subfigure}
    \vspace{0cm}
    \begin{subfigure}[t]{\textwidth}
    \centering
        \frame{\includegraphics[width=\linewidth]{"2015/other-finds-2015/CeciliaKan_Rigging_Snow (1)".jpg}} 
...
\begin{figure*}[t!]
\centering
\frame{\includegraphics[height=\textheight]{"2015/other-finds-2015/2015plan".pdf}}
\caption{}
\label{}
\end{figure*}
...
\begin{figure*}[t!]
\centering
\frame{\includegraphics[height=\textheight]{"2015/other-finds-2015/EE2015".pdf}}
\caption{}
\label{}
\end{figure*}