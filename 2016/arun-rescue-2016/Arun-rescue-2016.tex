\section{Account of the rescue}
    ...
    \begin{figure}[t]
        \checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
        \centering
        \frame{\includegraphics[width=\textwidth]{2016/arun-rescue-2016/migovec_cartoon 2.jpg}}
    ...
    \begin{figure*}[t]
        \checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
        \centering
        \frame{\includegraphics[width=\textwidth]{2016/arun-rescue-2016/KnotVeryGood.jpg}}
    ...
    \begin{figure*}[t!]
        \checkoddpage \ifoddpage \forcerectofloat \else \forceversofloat \fi
        \centering
        \begin{subfigure}[t]{0.448\textwidth}
            \centering
            \frame{\includegraphics[width=\linewidth]{2016/arun-rescue-2016/Passing down information}}
        ...
        \hfill
         ...
         \begin{subfigure}[t]{0.537\textwidth}
            \centering
            \frame{\includegraphics[width=\linewidth]{2016/arun-rescue-2016/Preparing stretcher}} 
        ...
        \begin{subfigure}[t]{\textwidth}
            \centering
            \frame{\includegraphics[width=\linewidth]{2016/arun-rescue-2016/Moving stretcher}} 
